...
namespace REPLY.Presentacion.AsistenteInstalacion
{
    public partial class InstalacionBd : Form
    {
        ...
        private void executa()
        {
            ...
            {
                Process Pross = new Process();
                Pross.StartInfo.FileName = "SQL2022-SSEI-Expr.exe";
        ...
        private void TimerCRARINI_Tick(object sender, EventArgs e)
        {
            ...
            rutaPREPARAR = rutaPREPARAR.Replace("ConfigurationFile.ini", @"SQL2022-SSEI-Expr\ConfigurationFile.ini");
